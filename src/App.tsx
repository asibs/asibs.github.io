            ...
            <div className="flex flex-col md:w-5/6 lg:flex-grow md:pl-10 lg:pl-15">
              <div className="items-center text-center md:items-start md:text-left">
                ...
                <p className="text-xl font-semibold leading-relaxed mb-3">
                  Experienced fullstack engineer and team leader
                </p>
              </div>
              ...
              <div className="text-left">
                <p className="leading-relaxed mb-3">
                  I have developed products and led teams in a wide range of organisations - from building
                  robotic control systems with hundreds of engineers at a large multi-national company, to
                  developing tech-for-good web apps at an early stage start-up with only a couple of other devs.
                </p>
                <p className="leading-relaxed mb-3">
                  I am well-versed in automating, optimising, and scaling up systems & organisations -
                  whether through code, business processes, infrastructure, or a combination. I have years
                  of experience leading development teams in order to build, enhance, and maintain large &
                  complex products.
                </p>
                <p className="leading-relaxed">
                  I am motivated & inspired by making the world a better place through innovation. I would be
                  especially excited to help solve challenges related to democracy and climate change.
                </p>
              </div>
            </div>
          </div>
          ...
          <Timeline>
            ...
            >
              ...
              <p className="leading-relaxed pl-4">
                ...
                thousands of users to take action on workers rights campaigns. I am currently focused on expanding
                the monetisation of the product by adding monthly subscriptions, and opportunities for users to
                promote campaigns by making a one-off payment.
              </p>
            </TimelineSection>
            ...
            >
              ...
              <p className="leading-relaxed pl-4 mb-6">
                ...
                Technology. As a member of the organisation's Senior Management Team, I was involved in non-technical
            ...
            >
              ...
              <p className="leading-relaxed pl-4 mb-6">
                ...
                up to teams of 9 developers. I was responsible for managing projects & products, liaising with multiple
                stakeholders on requirements and timelines, and managing & coaching software developers. I provided
                expert backup during complex out-of-hours issues.
              </p>
              ...
              <p className="leading-relaxed pl-4">
                ...
                integrating new mechanical & robotic hardware into Ocado's warehouses, and optimising real-time
          ...
          <Timeline>
            ...
            >
              ...
              <p className="leading-relaxed pl-2">
                I led the build of the Minimum Viable Product in a short timespan; Integrated the new app with
                legacy systems to provide backwards compatibility; Integrated with payment processors to generate
                income, and with analytics suites to monitor revenue; Created KPI dashboards for revenue & engagement
            ...
            >
              ...
              <p className="leading-relaxed pl-2 mb-2">
                I worked alongside the campaigns team to develop ideas & launch an MVP within ~2 weeks of the
                election being announced, then went through multiple rapid iterations to improve the app. I led
                a cross-functional team of developers, designers & campaigners (both in-house & external contractors).
              </p>
              <p className="leading-relaxed pl-2">
            ...
            >
              ...
              <p className="leading-relaxed pl-2 mb-2">
                I led the project to ensure 38 Degrees' tech platform was compliant with GDPR and
                Age Appropriate Design.
              </p>
              <p className="leading-relaxed pl-2">
                I researched existing off-the-shelf solutions, considering cost, ease-of-use for end-users &
                staff, and compliance. I integrated a cookie-consent solution which met all organisations needs.
                I designed and implemented changes to how users consented to join 38 Degrees' mailing list,
                and self-certify themselves as over 16 years old. This included liasing with 3rd party vendors
                to ensure they also updated their systems to comply with the regulation, and collaborating
                with them to ensure their updated systems integrated with the 38 Degrees CRM.
              </p>
            </TimelineSection>
            ...
            >
              ...
              <p className="leading-relaxed pl-2">
                I drove the business case for this new application and championed it to senior management. I
                collaborated with non-technical staff to define requirements, and led the design & implementation,
                including management of external contractors. I integrated 3rd party data into the system - automating
                the process of cleaning, transforming & loading the data. During the go-live phase, I trained staff on
                the use of the new app, and how to use it in conjunction with existing systems - ensuring it was
            ...
            >
              ...
              <p className="leading-relaxed pl-2 mb-2">
                My team were key to ensuring this large project met its primary objectives: Automating the
              ...
              <p className="leading-relaxed pl-2 mb-2">
                I performed various roles within my team - team lead, product owner, technical lead, and scrum
